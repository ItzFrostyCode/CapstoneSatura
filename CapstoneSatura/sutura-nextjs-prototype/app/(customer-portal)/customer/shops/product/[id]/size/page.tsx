    ...
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="bg-white p-12 rounded-2xl shadow-sm border border-gray-100 max-w-2xl w-full text-center">
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          <a href="/customer/shops/product/123/appointment" className="border-2 border-gray-200 hover:border-black p-8 rounded-xl flex flex-col items-center transition">
          ...
          <a href="/customer/shops/product/123/custom" className="border-2 border-gray-200 hover:border-black p-8 rounded-xl flex flex-col items-center transition">
