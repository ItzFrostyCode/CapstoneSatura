...
import { Search, Filter, Plus, Clock, Edit2, Trash2, X, FileText, Ruler, Phone, Mail, ShoppingCart, Users } from 'lucide-react';
    ...
    <div className="p-8 max-w-[1400px] mx-auto w-full relative">
      ...
      <div className="flex items-center gap-8 border-b border-slate-200 mb-6">
        <button 
          ...
          className={`pb-3 text-[14px] font-bold transition-all relative ${activeTab === 'directory' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}
        >
          Client Directory
          {activeTab === 'directory' && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-slate-900 rounded-full" />}
        </button>
        <button 
          onClick={() => setActiveTab('measurements')}
          className={`pb-3 text-[14px] font-bold transition-all relative ${activeTab === 'measurements' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}
        >
          Measurements
          {activeTab === 'measurements' && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-slate-900 rounded-full" />}
        </button>
        <button 
          onClick={() => setActiveTab('appointments')}
          className={`pb-3 text-[14px] font-bold transition-all relative ${activeTab === 'appointments' ? 'text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}
        >
          Appointments
          {activeTab === 'appointments' && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-slate-900 rounded-full" />}
        </button>
      </div>
        ...
        <div className="p-4 border-b border-slate-200 flex gap-4 bg-slate-50/50">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full max-w-md h-9 pl-9 pr-4 rounded-md bg-white border border-slate-200 text-[13px] outline-none focus:border-slate-300 transition-colors" 
            />
          </div>
          <button className="h-9 px-4 border border-slate-200 rounded-md text-[13px] font-semibold text-slate-700 flex items-center gap-2 hover:bg-slate-50 bg-white">
            ...
            <table className="w-full text-left text-[13px]">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Name</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Email</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Phone</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Registered</th>
                  ...
                  <tr key={i} className="hover:bg-slate-50 transition-colors">
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center font-bold text-[12px] text-slate-600">{c.name.charAt(0)}</div>
            ...
            <table className="w-full text-left text-[13px]">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Key Measurements</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Updated</th>
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredMeasurements.length > 0 ? filteredMeasurements.map((m, i) => (
                  <tr key={i} className="hover:bg-slate-50 transition-colors group">
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center font-bold text-[11px] text-slate-500">{m.customer.charAt(0)}</div>
          ...
          {activeTab === 'appointments' && (
            <table className="w-full text-left text-[13px]">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Customer</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Schedule</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Appointment Type</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Handled By</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600">Status</th>
                  <th className="px-5 py-3 text-[13px] font-medium text-slate-600 text-right">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                {filteredAppointments.length > 0 ? filteredAppointments.map((a, i) => (
                  <tr key={i} className="hover:bg-slate-50 transition-colors group">
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center font-bold text-[11px] text-slate-500">{a.customer.charAt(0)}</div>
