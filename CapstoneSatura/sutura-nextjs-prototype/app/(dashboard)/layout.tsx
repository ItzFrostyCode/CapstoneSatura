...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { name: 'Inventory', path: '/inventory', icon: <PackageSearch size={18} /> },
          ...
          {isDevMenuOpen && (
            <div className="absolute bottom-full left-4 right-4 mb-2 bg-slate-900 rounded-lg shadow-xl border border-slate-800 overflow-hidden animate-in fade-in slide-in-from-bottom-2 z-50">
              ...
              <div className="flex flex-col py-1">
                ...
                <Link href="/designer" className="px-4 py-2 text-[12px] font-medium text-slate-300 hover:text-white hover:bg-slate-800 transition-colors">Register (Designer)</Link>
                <Link href="/portal" className="px-4 py-2 text-[12px] font-medium text-slate-300 hover:text-white hover:bg-slate-800 transition-colors">Customer Portal</Link>
                <Link href="/production" className="px-4 py-2 text-[12px] font-medium text-slate-300 hover:text-white hover:bg-slate-800 transition-colors">Staff (Tailor)</Link>
                <Link href="/dashboard" className="px-4 py-2 text-[12px] font-medium text-slate-300 hover:text-white hover:bg-slate-800 transition-colors">Staff (Manager)</Link>
                <Link href="/admin" className="px-4 py-2 text-[12px] font-medium text-slate-300 hover:text-white hover:bg-slate-800 transition-colors">Admin Portal</Link>
              </div>
            </div>
          )}
        </div>
