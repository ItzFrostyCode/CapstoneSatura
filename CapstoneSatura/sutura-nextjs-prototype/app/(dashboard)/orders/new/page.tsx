  ...
  return (
    <div className="p-8 max-w-[1200px] mx-auto w-full">
      <div className="mb-6 flex items-center gap-4">
        <Link href="/orders" className="w-8 h-8 rounded-md bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:text-slate-900 transition-colors shadow-sm">
          <ArrowLeft size={16} />
        </Link>
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3 mt-4">
            <Link href="/orders" className="flex-1 h-12 border border-slate-300 bg-white rounded-lg font-bold text-[14px] text-slate-700 flex items-center justify-center hover:bg-slate-50 transition-colors shadow-sm">
              Cancel
            </Link>
