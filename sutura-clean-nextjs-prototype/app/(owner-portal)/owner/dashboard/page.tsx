...
import { 
  ...
  Truck, Wallet, BarChart3, LayoutGrid,
  ArrowRight, Activity, TrendingUp, Scissors, AlertCircle,
  Sparkles, Zap, Megaphone, Plus
} from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6 pb-20 max-w-[1450px] mx-auto animate-in fade-in duration-500">
      <main className="max-w-[1450px] mx-auto px-10 pt-8 space-y-10">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            { label: "Total Revenue", val: "₱" + (totalRevenue/1000).toFixed(0) + "k", sub: "Actual cash flow", color: "emerald" },
            { label: "Staffs", val: staff.length, sub: "Active personnel", color: "indigo" },
          ...
          <div className="lg:col-span-2 space-y-10">
            <section className="bg-white p-10 rounded-[48px] border border-slate-200 shadow-sm">
              <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-4">
                   <div className="w-10 h-10 bg-slate-900/10 text-slate-900 rounded-xl flex items-center justify-center"><Activity size={20}/></div>
                   <h2 className="text-2xl font-black text-slate-900 tracking-tight">Production Efficiency</h2>
                </div>
                <Link href="/owner/orders" className="text-[11px] font-black text-slate-900 uppercase tracking-widest hover:underline">Full Pipeline →</Link>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="bg-slate-900 rounded-[40px] p-10 text-white relative overflow-hidden group">
                 <div className="absolute top-0 right-0 w-40 h-40 bg-indigo-600 rounded-full -mr-20 -mt-20 opacity-20 group-hover:scale-110 transition-transform duration-700"></div>
                 <div className="relative z-10">
                    ...
                    <div className="mt-12 pt-8 border-t border-white/10 flex items-center justify-between">
                       ...
                       <button className="px-6 py-3 bg-indigo-600 text-slate-900 rounded-xl font-black text-[11px] uppercase tracking-widest hover:bg-indigo-600/90 transition-all">Reconcile</button>
                    </div>
                 </div>
              </div>
            </div>
        ...
        {activeTab === 'news' && (
          <div className="bg-white border border-slate-200 p-20 rounded-[48px] shadow-sm flex flex-col items-center justify-center text-center">
        ...
        {activeTab === 'welcome' && (
          <div className="bg-white border border-slate-200 p-20 rounded-[48px] shadow-sm flex flex-col items-center justify-center text-center">
            <Sparkles className="text-indigo-600 mb-6" size={48} />
