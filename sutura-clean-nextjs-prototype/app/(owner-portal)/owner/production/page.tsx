...
const STAGES: Array<{ key: ProductionStage; label: string; color: string; bg: string; orderStatus: OrderStatus }> = [
  ...
  { key: "READY_FOR_PICKUP",  label: "Ready",            color: "#1E3A1F",   bg: "#1E3A1F/5",  orderStatus: "READY_FOR_RELEASE" },
];
