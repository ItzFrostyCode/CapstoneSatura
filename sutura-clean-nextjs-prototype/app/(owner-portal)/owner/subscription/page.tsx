  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20 max-w-[1400px] mx-auto px-10 pt-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        ...
        <Link href="/owner/settings" className="inline-flex items-center gap-2 text-[13px] font-black text-slate-600 hover:text-slate-900 transition-all bg-white px-6 py-3 rounded-2xl border border-slate-200 shadow-sm">
