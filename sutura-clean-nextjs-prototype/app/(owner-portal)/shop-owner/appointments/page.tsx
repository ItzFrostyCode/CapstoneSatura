  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 max-w-[1450px] mx-auto pb-20">
      <main className="max-w-[1450px] mx-auto px-10 pt-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 mt-4">
          ...
          <div className="flex items-center gap-3">
             <button 
               ...
               className="h-10 px-5 bg-[#069668] text-white rounded-full flex items-center gap-2 text-[12px] font-bold hover:bg-emerald-700 transition-all shadow-md active:scale-95"
             >
            ...
            <div className="flex items-center gap-1.5 bg-slate-200/50 p-1 rounded-xl w-fit border border-slate-200/60 shadow-inner">
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-2 text-[11px] font-black rounded-lg transition-all duration-300 uppercase tracking-widest ${activeTab === tab.id ? 'bg-white text-[#069668] shadow-sm ring-1 ring-slate-200/50' : 'text-slate-400 hover:text-slate-600 hover:bg-white/40'}`}
                >
                  {tab.icon}{tab.label}
                </button>
              ))}
        ...
        {activeTab === 'calendar' && (
          <div className="flex flex-col bg-white border border-slate-200 overflow-hidden shadow-2xl shadow-slate-200/50 min-h-[800px]">
            <CalendarHeader 
                  ...
                  {appointments
                    ...
                    .map((apt) => (
                      <div 
                        ...
                        className="bg-white p-6 border border-slate-200 flex items-center justify-between hover:border-indigo-600 transition-all cursor-pointer group shadow-sm"
                      >
