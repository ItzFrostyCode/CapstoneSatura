...
const CUSTOMER = {
  ...
  appointments: [
    ...
    { id: 'apt-003', type: 'Appointment', date: '2025-08-18', status: 'Completed' },
  ],
};
...
export default function CustomerDetailPage() {
  return (
    <div className="relative min-h-full pb-20 pt-6">
      <Link href="/shop-owner/customers" className="inline-flex items-center gap-2 text-slate-400 hover:text-slate-700 text-[13px] font-bold mb-6 transition-colors">
