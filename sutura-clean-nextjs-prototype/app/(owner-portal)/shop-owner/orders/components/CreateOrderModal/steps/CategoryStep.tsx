...
export const CategoryStep: React.FC<CategoryStepProps> = ({ onSelect }) => {
  const categories = [
    { id: 'CUSTOM_TAILORING' as OrderType, icon: <User />, label: 'Custom Tailoring', desc: 'Bespoke / one-of-a-kind garment', color: 'bg-indigo-600' },
    { id: 'BULK_ORDER' as OrderType, icon: <Users />, label: 'Bulk Order (Uniforms)', desc: 'Group orders, teams, or corporate', color: 'bg-amber-500' },
    { id: 'REPAIR_ALTERATIONS' as OrderType, icon: <Scissors />, label: 'Repair & Alterations', desc: 'Adjustments, resizing, or patching', color: 'bg-rose-500' }
  ];
