...
export const INITIAL_STAFF: Staff[] = [
  { id: 'STF-001', name: 'Joshua Arabejo', roles: ['Owner', 'Admin'], phone: '0917-123-4567', email: 'joshua@sutura.com', hasSystemAccess: true, status: 'Online', branch_id: 'BRN-001', avatar: 'https://api.dicebear.com/7.x/big-smile/svg?seed=Molang&backgroundColor=b6e3f4' },
