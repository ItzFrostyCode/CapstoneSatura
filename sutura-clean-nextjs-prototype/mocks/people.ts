...
export const INITIAL_STAFF: Staff[] = [
  ...
  { id: 'STF-002', name: 'Bulka Chong',     roles: ['STAFF'],               specialization: ['Tailoring', 'Quality Check'],           phone: '0918-234-5678', email: 'bulka@sutura.com',    hasSystemAccess: true, status: 'Online',  branch_id: 'BRN-001', avatar: 'https://api.dicebear.com/7.x/big-smile/svg?seed=PiuPiu&backgroundColor=ffdfba'   },
